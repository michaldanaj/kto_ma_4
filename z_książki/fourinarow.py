...
def main():
    ...
    REDPILERECT = pygame.Rect(int(SPACESIZE / 2), int(3 * SPACESIZE / 2), SPACESIZE, SPACESIZE)
    BLACKPILERECT = pygame.Rect(WINDOWWIDTH - int(3 * SPACESIZE / 2),  int(3 * SPACESIZE / 2), SPACESIZE, SPACESIZE)
